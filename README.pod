...
This is the I<README> for the L<Tie::Toggle> Perl module. You're probably 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Tie-Toggle> or 
L<MetaCPAN|http://www.metacpan.org/module/Tie::Toggle>:

=over 4

=item *	L<http://search.cpan.org/dist/Tie-Toggle>

=item *	L<http://www.metacpan.org/module/Tie::Toggle>
